...
void main()
{
	...
	while(1)
	{
		...
		switch(i) //同上
		{
			case 0:P0=0xff;p21=0;p22=1;p23=1;p24=1;P0=led[ch[0]];i++;break;
			case 1:P0=0xff;p21=1;p22=0;p23=1;p24=1;P0=led[ch[1]];i=0;break;
			default:break;
		}
	}
}
...
void main()
{
	...
	while(1)
	{
		...
		num[0]=hour/10;num[1]=hour%10;
		num[2]=minute/10;num[3]=minute%10;
		switch(i)
		{
			case 0:P0=0xff;p21=0;p22=1;p23=1;p24=1;P0=led[num[0]];i++;break;
			case 1:P0=0xff;p21=1;p22=0;p23=1;p24=1;P0=led[num[1]];i++;break;
			case 2:P0=0xff;p21=1;p22=1;p23=0;p24=1;P0=led[num[2]];i++;break;
			case 3:P0=0xff;p21=1;p22=1;p23=1;p24=0;P0=led[num[3]];i=0;break;
			default:break;
		}
	}
}
